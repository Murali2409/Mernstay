...
import PropTypes from 'prop-types';  //for checking the type of props
...
const FilterModal = ({selectedFilters, onFilterChange, onClose}) => {
    ...
    // useEffect hook is used to update the states when selectedFilters changes
    useEffect( () => {
        setPriceRange({
            min: selectedFilters.priceRange?.min || 600,
            max: selectedFilters.priceRange?.max || 30000,
            ...
            <div className='modal-content'>
                ...
                <div className='modal-filters-container'>
                    ...
                    <div className="filter-buttons">
                        <button className='clear-button' onClick={handleClearFiler}>
                            Clear
                        </button>
